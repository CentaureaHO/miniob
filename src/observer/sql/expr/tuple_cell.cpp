...
TupleCellSpec::TupleCellSpec(const char* table_name, const char* field_name, const char* alias, AggregationType agg_type)
{
    ...
    {
        if (agg_type == AggregationType::F_COUNT_ALL) alias_ = "COUNT(*)";
        else 
        {
