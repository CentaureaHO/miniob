...
{
    if (type >= UNDEFINED && type <= DATES) return ATTR_TYPE_NAME[type];
    return "unknown";
}
AttrType attr_type_from_string(const char* s)
{
    for (unsigned int i = 0; i < sizeof(ATTR_TYPE_NAME) / sizeof(ATTR_TYPE_NAME[0]); ++i)
        if (0 == strcmp(ATTR_TYPE_NAME[i], s)) return (AttrType)i;
    return UNDEFINED;
}
...
int Value::compare(const Value& other) const
{
    ...
    {
        return common::compare_str2float((void*)this->str_value_.c_str(), (void*)&other.num_value_.float_value_);
    }
    else if (this->attr_type_ == FLOATS && other.attr_type_ == CHARS)
    {
        return common::compare_float2str((void*)&this->num_value_.float_value_, (void*)other.str_value_.c_str());
    }
    else if (this->attr_type_ == CHARS && other.attr_type_ == INTS)
    {
        return common::compare_str2int((void*)this->str_value_.c_str(), (void*)&other.num_value_.int_value_);
    }
    else if (this->attr_type_ == INTS && other.attr_type_ == CHARS)
    {
        return common::compare_int2str((void*)&this->num_value_.int_value_, (void*)other.str_value_.c_str());
    }
